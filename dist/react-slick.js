...
/***/ (function(module, exports, __webpack_require__) {
	...
	var InnerSlider = exports.InnerSlider = (0, _createReactClass2.default)({
	  ...
	  wrapperRefHandler: function wrapperRefHandler(ref) {
	    this.wrapper = ref;
	  },
	  lightboxRefHandler: function lightboxRefHandler(ref) {
	    this.lightbox = ref;
	  },
	  ...
	  render: function render() {
	    ...
	    var finalSlider = _react2.default.createElement(
	      'div',
	      {
	        className: className,
	    ...
	    return this.state.lightboxOpen ? _react2.default.createElement(
	      'div',
	      { className: 'slick-wrapper', ref: this.wrapperRefHandler },
	      _react2.default.createElement(
	        'div',
	        { className: 'slick-lightbox-overlay', onClick: this.onClickWrapper },
	        _react2.default.createElement(
	          'div',
	          { ref: this.lightboxRefHandler, className: 'slick-lightbox' },
	          finalSlider
	        )
	      )
	    ) : _react2.default.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EventHandlers = {
	  ...
	  showLightbox: function showLightbox() {
	    if (this.props.lightbox) {
	      if (this.lightbox && this.state.lightboxOpen) {
	        var lightbox = _reactDom2.default.findDOMNode(this.lightbox);
	        lightbox.classList.add('open');
	        var wrapper = _reactDom2.default.findDOMNode(this.wrapper);
	  ...
	  lightboxHandler: function lightboxHandler() {
	  ...
	  onClickWrapper: function onClickWrapper(e) {
	    if (this.state.lightboxOpen) {
	      this.closeLightbox();
	    }
	  }
